...
file_path = "/Users/yeonji/Dropbox/myfolder_data/wbp_last/"
sim = "ahr_eq"
data_table_files = sorted(glob.glob(file_path+sim+"/match/fcnl_grp_close/*csv"))
...
plt.tight_layout()
fig.savefig(file_path+sim+"/match/"+sim+"_match_analysis.png")
plt.show()
out_df.to_csv(file_path+sim+"/match/"+sim+"_position_match.csv")